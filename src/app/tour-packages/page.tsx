...
const TourArchiveLayout = dynamic(
  () => import("@/components/TourArchive/TourArchiveLayout"),
);
const TourFilters = dynamic(
  () => import("@/components/TourArchive/TourFilters"),
);
const TourGrid = dynamic(() => import("@/components/TourArchive/TourGrid"));
const TourTrustStrip = dynamic(
  () => import("@/components/TourArchive/TourTrustStrip"),
);
const ToursReadMore = dynamic(
  () => import("@/components/TourArchive/TourReadMore"),
);
const TourFAQSection = dynamic(
  () => import("@/components/TourArchive/TourArchiveFAQS"),
);
const TourArchiveCTA = dynamic(
  () => import("@/components/TourArchive/TourArchiveCTA"),
);
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Mathura Vrindavan Tour Packages | 1 Day, 2 Day & Braj Yatra Packages",
  ...
  openGraph: {
    title: "Mathura Vrindavan Tour Packages | Braj Yatra & Temple Tours",
    description:
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Tour packages include visits to Banke Bihari Temple, Prem Mandir, ISKCON Temple, Krishna Janmabhoomi and other sacred Braj temples.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most travelers prefer 1 day or 2 day tour packages to explore Mathura and Vrindavan temples and spiritual attractions.",
        },
      },
    ],
  };
