      ...
      <div className="sticky top-28 h-fit">
        <div className="bg-white rounded-3xl shadow-xl p-6 border border-amber-100">
          ...
          <div className="flex justify-between font-semibold text-lg">
            <span>Total</span>
            <span className="text-amber-600">Distance x {taxi.basePrice}</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 mt-6 text-xs text-center">
            <div className="bg-amber-50 rounded-lg p-2">🔒 Secure</div>

            <div className="bg-amber-50 rounded-lg p-2">
              💸 No Hidden Charges
            </div>

            <div className="bg-amber-50 rounded-lg p-2">📞 24/7 Support</div>
          </div>
        </div>
      </div>
    );
