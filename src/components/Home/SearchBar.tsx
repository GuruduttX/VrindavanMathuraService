           ...
           <div className="grid grid-cols-2 sm:flex gap-3 mt-8 w-full">
            ...
            <div className="mt-6 w-full">
                ...
                <div className="flex items-center gap-2 bg-white/80 backdrop-blur-xl border border-pink-100 shadow-xl rounded-full p-2 md:p-3">
                    ...
                    <button className="bg-gradient-to-r from-pink-600 to-fuchsia-600 text-white px-4 md:px-7 py-2 md:py-3 rounded-full flex items-center gap-2 hover:scale-105 hover:shadow-lg transition cursor-pointer font-medium">
                        <Search size={18} />
