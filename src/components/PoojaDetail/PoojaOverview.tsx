      ...
      <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="inline-flex items-center gap-2 w-fit px-4 py-1.5 rounded-full bg-amber-50 border border-amber-200">
            ...
            <span className="text-amber-600 text-xs font-semibold uppercase tracking-widest">Mathura & Vrindavan</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 mt-2">
            ...
            <button className="inline-flex items-center gap-2 text-amber-600 text-sm font-semibold
