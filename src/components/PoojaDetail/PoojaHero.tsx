    ...
    <section className="relative w-full min-h-[92vh] flex items-center overflow-hidden">
      ...
      <div className="absolute right-10 top-1/2 -translate-y-1/2 hidden lg:block pointer-events-none opacity-[0.12]">
        <svg width="400" height="400" viewBox="0 0 400 400" fill="none">
          <circle cx="200" cy="200" r="190" stroke="white" strokeWidth="1" strokeDasharray="8 6" />
          <circle cx="200" cy="200" r="150" stroke="white" strokeWidth="0.6" strokeDasharray="4 8" />
          ...
          <circle cx="200" cy="200" r="16" stroke="white" strokeWidth="1.2" fill="none" />
          <text x="200" y="206" textAnchor="middle" fill="white" fontSize="16" fontFamily="serif">ॐ</text>
        </svg>
      </div>
      ...
      <div className="absolute bottom-7 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1
        ...
        >
          <path d="M6 1v10M1 8l5 5 5-5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </div>
