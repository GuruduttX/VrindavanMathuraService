      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="block text-gray-800 mt-2">in Vrindavan Today</span>
          </motion.h2>

          <p className="text-gray-600 mt-6 max-w-2xl mx-auto">
            Book your spiritual tour, comfortable taxi rides, and peaceful hotel
            stays with trusted local services in Vrindavan.
          </p>
